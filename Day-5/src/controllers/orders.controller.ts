...
export const listOrders = async (_: Request, res: Response) => {
  ...
  return res.ok(data, "Order fetched successfully");
};
...
export const createOrder = async (req: Request, res: Response) => {
  ...
  try {
    ...
    return res.created(data, "Order created successfully");
  } catch (e: any) {
...
export const updateOrder = async (req: Request, res: Response) => {
  ...
  try {
    ...
    return res.updated(data, "Order updated successfully");
  } catch (e: any) {
...
export const deleteOrder = async (req: Request, res: Response) => {
  ...
  try {
    ...
    return res.deleted(data, "Order deleted successfully");
  } catch (e: any) {
